...
运行：
    python3 serial_arm_model_viewer.py
    python3 serial_arm_model_viewer.py --config ../../serial_arm_bringup/config/dm_arm_white.yaml
...
DEFAULT_CONFIG = Path(__file__).resolve().parents[2] / "serial_arm_bringup" / "config" / "dm_arm_white.yaml"
