...
function(dm_arm_add_dm_damiao_adapter_target target_name)
    ...
    if(NOT TARGET impedance::impedance_controller AND NOT TARGET impedance_controller)
    ...
    if(TARGET impedance::impedance_controller)
        set(_dm_arm_control_core_target impedance::impedance_controller)
    else()
...
function(dm_arm_add_impedance_controller_target target_name)
    ...
    add_library(${target_name} SHARED
        ${DM_ARM_SOURCE_DIR}/src/core/impedance_controller/src/dynamics_observer.cpp
        ${DM_ARM_SOURCE_DIR}/src/core/impedance_controller/src/joint_impedance_controller.cpp
        ${DM_ARM_SOURCE_DIR}/src/core/impedance_controller/src/pinocchio_dynamics_model.cpp
    )
    set_target_properties(${target_name}
        PROPERTIES
            BUILD_RPATH "${DM_ARM_PINOCCHIO_RUNTIME_PREFIX}/lib"
    ...
    target_include_directories(${target_name}
        PUBLIC
            $<BUILD_INTERFACE:${DM_ARM_SOURCE_DIR}/src/core/impedance_controller/include>
            $<INSTALL_INTERFACE:include>
    )
